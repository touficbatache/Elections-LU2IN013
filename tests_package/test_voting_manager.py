...
class TestVotingManager(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.voting_profils = {
            "1": [("D", 0.70), ("A", 0.68), ("E", 0.60), ("C", 0.59), ("B", 0.57)],
            "2": [("D", 0.65), ("A", 0.53), ("E", 0.48), ("C", 0.45), ("B", 0.43)],
            "3": [("D", 0.79), ("C", 0.46), ("A", 0.44), ("B", 0.42), ("E", 0.34)],
            "4": [("C", 0.98), ("B", 0.96), ("A", 0.73), ("D", 0.61), ("E", 0.56)],
            "5": [("A", 0.85), ("C", 0.74), ("B", 0.73), ("E", 0.72), ("D", 0.64)],
            "6": [("E", 0.93), ("A", 0.78), ("B", 0.53), ("C", 0.50), ("D", 0.36)],
            "7": [("D", 0.75), ("C", 0.41), ("B", 0.36), ("A", 0.26), ("E", 0.12)],
            "8": [("A", 0.89), ("E", 0.77), ("B", 0.72), ("C", 0.71), ("D", 0.59)],
            "9": [("D", 0.89), ("C", 0.53), ("B", 0.48), ("A", 0.44), ("E", 0.32)],
            "10": [("D", 0.85), ("C", 0.51), ("B", 0.47), ("A", 0.46), ("E", 0.35)],
        }

        self.voting_profils_condorcet = {
            "1": [("A", 0.70), ("B", 0.68), ("C", 0.60)],
            "2": [("B", 0.65), ("C", 0.53), ("A", 0.48)],
            "3": [("C", 0.79), ("A", 0.46), ("B", 0.44)],
        }
